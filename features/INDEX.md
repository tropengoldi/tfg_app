...
|----|---------|--------|------|---------|
| PROJ-1 | Supabase-Infrastruktur | Roadmap | – | 2026-08-27 |
...
| PROJ-10 | Profil-Seite | Roadmap | – | 2026-08-27 |
...
Whiskys existieren und eine Runde läuft.
...
| **PROJ-4** | **Admin – Tasting-Events verwalten** | Event anlegen und bearbeiten: Gastgeber, Datum, Ort, Teilnehmerliste, maximale Anzahl Whiskys pro Person, Thema | P0 | PROJ-3 |
| **PROJ-5** | **Whisky-Erfassung (blind)** | Teilnehmer trägt die von ihm mitgebrachten Whiskys ein; Limitprüfung; nur der Bringer und der Gastgeber sehen die Details | P0 | PROJ-4 |
...
| **PROJ-9** | **Ergebnisse & Tasting-Historie** | Rangliste nach Abschluss (Gesamt-, Nasen-, Geschmackspunkte), Liste vergangener Tastings mit Datum, Gastgeber und Sieger-Whisky, Detailansicht | P1 | PROJ-7 |
| **PROJ-10** | **Profil-Seite** | Eigene Daten im Whisky-Look bearbeiten: Anzeigename, Lieblings-Dram, Lieblingsregion, Kurzbeschreibung | P2 | PROJ-2 |
